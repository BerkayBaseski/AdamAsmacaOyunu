...
const getRandomWord = () => {
    // Selecting a random word from sessionStorage
    currentWord = sessionStorage.getItem("kelime");
    document.querySelector(".hint-text b").innerText = sessionStorage.getItem("ipucu");
    resetGame();
}
